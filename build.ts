...
const PERMS = [
  ...
  "--allow-env",
  "--allow-run",
  // `supa upgrade` (self-update) only: GitHub API + release downloads (incl.
  // the CDN hosts the asset redirects land on). No other network access.
  "--allow-net=api.github.com,github.com,objects.githubusercontent.com,release-assets.githubusercontent.com",
];
